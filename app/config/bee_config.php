...
define('BASEPATH'     , IS_LOCAL ? '/proyectos/sistema_escolar/' : '____EL BASEPATH EN PRODUCCIÓN___'); // Debe ser cambiada a la ruta de tu proyecto en producción y desarrollo
